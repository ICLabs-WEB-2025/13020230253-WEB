<x-app-layout>
    <div class="container mt-4">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('buyer.offers') }}" class="row g-3">
                    <div class="col-md-6">
            ...
            <div class="card shadow-sm mb-3">
                <div class="card-body">
                    ...
                    @if ($offer->status == 'Tertunda')
                        <form action="{{ route('buyer.cancel', $offer) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Yakin membatalkan penawaran ini?')">Batalkan</button>
                        </form>
                    @endif
                </div>
            </div>
